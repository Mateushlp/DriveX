...
const carrosDados = {
  ...
  "BMW serie 3": {
    ...
    img: "./img/nivus.jpg",
      ...
      "911": {
    descricao: "Suspensão adaptativa PASM, motor boxer biturbo com equilíbrio perfeito, tração traseira ou integral, modo Wet para segurança em chuva, interior esportivo com luxo discreto e acabamento premium Porsche, ",
    preco: "R$ 120.000",
