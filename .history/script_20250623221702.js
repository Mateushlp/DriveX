...
const carrosDados = {
  ...
  "BMW serie 3": {
    ...
    img: "./img/nivus.jpg",
      ...
      "911": {
    descricao: "Sistema de suspensão adaptativa (PASM) para conforto e esportividade.

Painel com conta-giros analógico clássico e cinco visores digitais.

Versões com tração traseira ou integral (Carrera 4).

Construção em alumínio e aço para leveza e rigidez.

Possui modo Wet para dirigir com segurança em pisos molhados.
