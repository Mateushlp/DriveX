...
const carrosDados = {
  ...
  "911": {
    descricao: "Suspensão adaptativa PASM, motor boxer biturbo com equilíbrio perfeito, tração traseira ou integral, modo Wet para segurança em chuva, interior esportivo com luxo discreto e acabamento premium Porsche, Ícone mundial com DNA de competição, direção precisa e visceral, carroceria aerodinâmica para máxima estabilidade, painel com tradição e tecnologia, desempenho brutal com elegância, feito para quem valoriza exclusividade real.",
    preco: "R$ 120.000",
...
// Abre modal ao clicar nos botões "Saiba mais"
