...
botoesOferta.forEach((btn) => {
  ...
  // No seu carros.js ou inline no carros.html, após carregar os botões:
  // (Removida a segunda declaração de usuarioLogado)

if (!usuarioLogado) {
  // Desativa os botões ou redireciona para login
  document.querySelectorAll('.btn-encomenda, .btn-oferta').forEach(btn => {
    btn.addEventListener('click', () => {
  ...
  // Aqui mantém o seu código atual para tratar pedidos e ofertas
  // ...
}
