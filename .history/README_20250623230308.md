...
![DriveX Banner](./img/banner-drivex.png) <!-- Substitua com o caminho correto da imagem ou uma URL externa -->
...
![Screenshot DriveX](./img/screenshot.png) <!-- Troque pelo caminho correto da imagem da homepage do seu site -->
